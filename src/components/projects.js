...
class Projects extends Component {
  ...
  renderCard1Back = () => {
                  return <Card className='cardBack' shadow={5} onMouseLeave = {this.hoverCardOne1} style={{minWidth: '450', margin:'auto', marginBottom:'7vh'}}>
...
renderCard3Back = () => {
  ...
  return <Card className='cardBack' onMouseLeave = {this.hoverCardOne3}  shadow={5} style={{minWidth: '450', margin:'auto', marginBottom:'7vh'}}>
