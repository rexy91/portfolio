...
export class newLanding extends Component {
    render() {
        ...
        <p>Passionate about coding and problem solving. Possess strong skills in collaborating with team and pair-programming. <br></br>Seeks opportunites with room to grow.</p>
